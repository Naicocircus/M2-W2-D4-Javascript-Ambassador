...
if (totaleCarrello > 100) {
  console.log(`Il totale del carrello per ${utenteCheEffettuaLAcquisto.name} ${utenteCheEffettuaLAcquisto.lastName} è €${totaleCarrello.toFixed(2)} con spedizione gratuita.`);
} else {
  totaleCarrello += shippingCost;
  console.log(`Il totale del carrello per ${utenteCheEffettuaLAcquisto.name} ${utenteCheEffettuaLAcquisto.lastName} è €${totaleCarrello.toFixed(2)}, con €${shippingCost} di spedizione inclusa.`);
}
